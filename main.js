...
function conferirSeALetraJaFoiChutada(letraAgora) {
  if (
    letrasInformadas.indexOf(letraAgora) !== -1 &&
    letrasPalavra.indexOf(letraAgora) == -1
  ) {
    return true;
  } else {
...
const letrasPalavraMudavel = letrasPalavra.map(e => e)
  ...
  console.log(letrasPalavra, letrasPalavraMudavel)
...
function verificarSeTemMenosDeTresLetras() {
  ...
  console.log(quantasLetrasFaltam)
  quantasLetrasFaltam <= 3 ? (document.getElementById("input-letras").setAttribute("readonly", ""), alert("Chute uma palavra")) : false
